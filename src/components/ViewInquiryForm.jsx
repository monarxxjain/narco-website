...
const checkDateValidity = (offer, checkInDate, checkOutDate) => {
    ...
    if (checkInDateFromQuery >= checkInDateFromRecord && checkInDateFromQuery <= dateBeforeMinNights) {
...
const ViewInquiryForm = (
    ...
    useEffect(() => {
        ...
        // }
    }, [offer['Nome Offerta'], offer['Valida dal'], checkInDate, checkOutDate, NomeModulo, Hotel]);
    ...
    }, [offer['Nome Offerta'], offer['Valida dal'], checkInDate, checkOutDate, dateValid]);
